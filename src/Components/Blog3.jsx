...
// import pepperSpoon from '../assets/images/pepperSpoon.png'
        ...
        <div className=''>
            <div className='bg-stone-50 rounded-xl mb-10' >
                <div className='h- text-center'>
                    ...
                    <img src={food} alt="image" className='group-hover:scale-95 ease-in duration-300 object-cover object-center w-full h-full rounded-[3rem] p-5'/>
                    </p>
                ...
                <div className='md:mx-10 mx-5'>
                    ...
                    <h1 className='lg:text-4xl hover:cursor-pointer px-1 py-4 font-bold hover:underline decoration-[#EC094D] decoration-2 underline-offset-4'>
                        Mejora drásticamente tu cocina usando solo tu imaginación.
                    </h1>
                    <p className="text-sm text-stone-500 flex items-center justify-start">
                        <span className='flex items-center'> <LiaUserEditSolid className='mr-1'/>Apurba Talukdar</span>
                ...
                <div className='md:mx-10 mx-5 py-5 text-stone-700'>
                    ...
                    <div className='my-10 text-center'>
                        <p className='md:h-96 h-60 group'>
                            <img src={json} alt="image" className='group-hover:scale-95 ease-in duration-300 object-cover object-center w-full h-full rounded-[3rem] md:p-5'/>
                        </p>
                    ...
                    <div className='h- text-center'>
                        <p className='md:h-96 h-60 group'>
                        <img src={kitchen} alt="image" className='object-cover object-center w-full h-full rounded-[3rem] p-5 group-hover:scale-95 ease-in duration-300'/>
                        </p>
                    ...
                    {/* ghost */}
                    <div className='border my-5 rounded-lg flex flex-col sm:flex-row sm:h-60 h-80 justify-center items-center bg-white hover:cursor-pointer'>
                        <div className='w-full md:mx-5 p-2 items-cente flex flex-col justify-center'>
                            <h2 className='font-bold text-lg text-black md:pt-4 hover:underline decoration-[#EC094D] decoration-2 underline-offset-4'>{truncateString('Es durante nuestros momentos más oscuros que debemos concentrarnos para ver la luz.',40)}</h2>
                            <p className='capitalize md:py-3 text-sm '>{truncateString('Mina se interesó cada vez más por todo y me alegró ver que la exigencia de las cosas la ayudaba a olvidar por un tiempo la terrible experiencia de la noche. Estaba muy, muy pálida.', 90)}</p>
                            <p className='text-xs py-2 text-stone-600 font-bold'>Viox Surabhi Gupta</p>
                        </div>
                        <div className='sm:h-2/3 h-1/2 flex md:h-full md:w-1/2 w-full p-3 order-first sm:order-2 group'>
                            <img src={ocean} alt="image" className='rounded-lg w-full h-full object-cover group-hover:scale-95 duration-300 ease-linear' />
                        </div>
                    </div>
                    <p className='py-5'>
            ...
            <div className='bg-stone-100 rounded-lg border mb-5'>
                <div className='flex justify-center p-2 h-48'>
                    <div className='w-1/3 h-full group transition-all'>
                        <img src={author1} alt="image" className='w-full h-full object-cover rounded-2xl group-hover:scale-95 ease-out duration-300 '/>
                    </div>
                    <div className='w-2/3 p-3 '>
                        <p className='font-bold text-stone-700 text-lg p-2'>Surabhi Gupta</p>
            ...
            <div className='h-96 bg-stone-50 rounded-xl my-5 mb-10 flex flex-col justify-center items-center'>
                <div>
                    <ul className='flex justify-between items-center p-5 w-full space-x-12'>
